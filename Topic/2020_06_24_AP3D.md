## Réunion AP 3D assises du GDR Magis
# Tour de table
 * 18 participants
...
*  Webinar 3D ; Rappel du fonctionnement. Les thèmes que nous pourrions aborder à partir de la rentrée
   ...
   * Quels thèmes aborder ?
    ...
    * Contrôle de la cohérence et de la validité des données 3D
 ...
 * Discussion sur la mise en place d’Ateliers techniques 3D (en présentiel)
    * iTowns/ Cesium
    * Demander à des grands du domaine (ESRI, Autodesk, Safe/ FME, Bentley systems)
